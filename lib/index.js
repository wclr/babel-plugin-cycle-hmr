...
exports.default = function (_ref2) {
  ...
  var makeVisitor = function makeVisitor(scope, moduleIdName, options) {
    ...
    var wrap = function wrap(node, name) {
      ...
      return t.callExpression(wrapIdentifier, [node, t.binaryExpression('+', t.identifier('module.id'), t.stringLiteral('_' + moduleIdName + name))].concat(options.proxy ? t.identifier(JSON.stringify(options.proxy)) : []));
    };
