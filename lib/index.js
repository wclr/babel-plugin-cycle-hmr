...
exports.default = function (_ref2) {
  ...
  var makeVisitor = function makeVisitor(scope, options) {
    ...
    var wrap = function wrap(node, name) {
      ...
      return t.callExpression(wrapIdentifier, [node, t.binaryExpression('+', t.identifier('module.id'), t.stringLiteral('_' + name))]);
    };
...
var checkIncludeComments = function checkIncludeComments() {
